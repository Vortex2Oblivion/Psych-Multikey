...
class Note extends FlxSprite
{
	...
	public static var defaultKeyCount:Int = 4;
	...
	function loadNoteAnims() {
		if (isSustainNote)
		{
			animation.addByPrefix('hold', ManiaData.noteAnimations[PlayState.SONG.keyCount][noteData] + ' hold0');
			animation.addByPrefix('holdend', ManiaData.noteAnimations[PlayState.SONG.keyCount][noteData] + ' hold end0');
		}
		else animation.addByPrefix('Scroll', ManiaData.noteAnimations[PlayState.SONG.keyCount][noteData] + '0');

		if (!isSustainNote)
			setGraphicSize(Std.int(157 * ManiaData.noteSizes[PlayState.SONG.keyCount]));
		else
			setGraphicSize(Std.int(157 * ManiaData.noteSizes[PlayState.SONG.keyCount]), Std.int(154 * ManiaData.noteSizes[0]));
